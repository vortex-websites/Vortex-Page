...
declare type UnpluginFactory<UserOptions> = (options: UserOptions, meta: UnpluginContextMeta) => Arrayable<UnpluginOptions>;
...
interface UnpluginInstance<UserOptions> {
    rollup: UnpluginFactoryOutput<UserOptions, Arrayable<Plugin>>;
    vite: UnpluginFactoryOutput<UserOptions, Arrayable<Plugin$1>>;
    webpack: UnpluginFactoryOutput<UserOptions, WebpackPluginInstance>;
    esbuild: UnpluginFactoryOutput<UserOptions, Plugin$2>;
    raw: UnpluginFactory<UserOptions>;
}
declare type UnpluginContextMeta = Partial<PluginContextMeta> & ({
